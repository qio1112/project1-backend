...
public interface FormulaPageDataDao {
	...
	// deletion
	int deleteFormulaPageData(ProjectEntity project, String resourceCode, String columnName);
	
	int deleteFormulaPageDataByProjectResourceCode(ProjectEntity project, String resourceCode);
	
	int deleteFormulaPageDataByProject(ProjectEntity project);
	
	int deleteFormulaPageDataByProjectColumnName(ProjectEntity project, String columnName);
}
